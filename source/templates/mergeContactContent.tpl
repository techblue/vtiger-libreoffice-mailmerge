        ...
        {else}
            ...
            <input type="hidden" name="page" value="{$PREV}">
                ...
                {else}
                    ...
                    <input type="hidden" name="module" value="MailMerge">
                    <input type="hidden" name="view" value="createMergeContact">
                    <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button onclick="document.getElementById('merge').submit();" class="btn btn-primary" id="merged" style="background-color: #428bca">Merge</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
