...
<table width="100%" class="table-bordered" style="border: 1px solid #ddd;table-layout: fixed">
    <tr>{foreach item=RECORD from=$ALPHABETS}
        <td class="alphabetSearch textAlignCenter cursorPointer " style="padding : 0px !important;height:40px"><a id="A" href="index.php?module=MailMerge&view=Accounts&search={$RECORD}"><div class="alphabetSorting noprint">{$RECORD}</div></a></td>
                {/foreach}
        </tr>
    </table>
                    ...
                    <tr>
                        {foreach name=FIELDNAME item=FIELDVALUE from=$RECORD}
                            {if $COUNTER eq 0}
                               ...
                               <!-- <td><a style="color:#51a7e8;" href="index.php?module=CityLookup&view=Edit&record={$FIELDVALUE}">{$FIELDVALUE}</a></td>-->
        ...
        {else}
            ...
            <input type="hidden" name="page" value="{$PREV}">
                ...
                {else}
                    ...
                    <input type="hidden" name="module" value="MailMerge">
                    <input type="hidden" name="view" value="createMergeAccount">
                    <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
