...
class MailMerge_createMergeContact_View extends Vtiger_Index_View {
...
alert('select an entity');
            ...
            header('location: index.php?module=Contacts&view=List&error=1');
        }
        ...
        unlink($delefile1);
          ...
          //  echo $delefile;
            ...
            foreach ($mass_merge as $idx => $entityid) {
                 ...
                 $rs = $db->pquery("select * from vtiger_contactdetails where contactid=?", array($entityid));
